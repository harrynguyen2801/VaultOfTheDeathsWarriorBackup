...
public class WeaponItem : MonoBehaviour
{
    ...
    public int WeaponId;
    private Tuple<string, string, int, int, int, int, string, Tuple<int>> dataWeapon;
    public void SetDataWeapon(int weaponId, Tuple<string, string, int, int, int, int, string, Tuple<int>> data)
    {
        dataWeapon = data;
    ...
    public void SetDataWeaponInventory(int weaponId, Tuple<string, string, int, int, int, int, string, Tuple<int>> data)
    {
        dataWeapon = data;
        weaponImg.sprite = Resources.Load<Sprite>("WeaponSprites/" + weaponId);
        weaponName.text = data.Item1;
    ...
    {
        Tuple<string, string, int, int, int, int, string, Tuple<int>> dataWeaponNew =
            new Tuple<string, string, int, int, int, int, string, Tuple<int>>(dataWeapon.Item1,dataWeapon.Item2,dataWeapon.Item3,dataWeapon.Item4,dataWeapon.Item5,dataWeapon.Item6,dataWeapon.Item7,new Tuple<int>(1));
